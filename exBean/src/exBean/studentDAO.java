...
public class studentDAO {
 public void insertStudent(studentVO item) throws Exception {
  ...
  Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","201517574","201517574");
 ...
 public List<studentVO> selectStudent() throws Exception { //List에 record set을 담아 넘겨 준다
	   ...
	   Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","201517574","201517574"); // DB 접속
